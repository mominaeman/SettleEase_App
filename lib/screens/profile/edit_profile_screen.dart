...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  Future<void> _loadUserData() async {
    ...
    if (userData != null) {
      setState(() {
        ...
        phoneNumberController.text = (userData.phoneNumber ?? '').replaceAll(
          RegExp(r'^\+\d+'),
          '',
        );
        selectedCountryCode =
            RegExp(r'^(\+\d+)').stringMatch(userData.phoneNumber ?? '') ??
            '+92';
  ...
  Future<void> _saveProfile() async {
    ...
    final updatedUser = UserModel(
      ...
      // photoUrl: you'll handle Firebase Storage upload later if needed
    );
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  onChanged:
                      (value) =>
                          setState(() => selectedCurrency = value ?? 'PKR'),
